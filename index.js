...
myApp.container
=======
const wss = `wss://` + window.location.host + `/websocket?user=`
//test
// const localhost = `ws://localhost:8888/websocket?user=`
let myApp = {}

// instantiated in init
myApp.websocket  
myApp.container   // document.getElementById('container')
>>>>>>> 3a23d3484acd8ec77e75db12861cbb0a0842a5c0:public/app.js
...
=======
    ...
    myApp.websocket = new WebSocket(`${wss}${user}`)
